...
public class ResolverController {
    ...
    public String stringReturning(Model model){
        ...
        * ThymleafViewResolver에게 resources/template/ 를 prefix로 .html을 suffix로 하여
    ...
    public String stringRedirect(){
        ...
        /*저두사로 redirect:을 하면 forward가 아닌 redirect시킨다.*/
        return "redirect:/";
    }
    ...
    * 하지만 스프링에서는 RedirectAttribute 타입을 통해 redirect 시 속성값을 저장할 수 있도록 하는 기능을 제공한다.*/
    ...
    public ModelAndView modelAndViewReturning(ModelAndView mv){
        /*모델과 뷰를 합친 개념이다.
        * 핸들러 어댑터가 핸들러 메소드를 호출하고 반환받은 문자열을 ModelAndView로 만들어 dispatcherServlat에 반환한다.
