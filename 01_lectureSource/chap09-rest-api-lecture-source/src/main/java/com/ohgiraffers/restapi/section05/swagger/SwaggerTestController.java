...
public class SwaggerTestController {
    ...
    @Operation(summary = "전체 회원 조회", description = "전체 회원 조회 목록을 조회한다.")
    @GetMapping("/users")
    ...
    /*회원 상세 조회*/
    @Operation(summary = "회원 상세 조회", description = "회원 상세 조회를 한다.")
    ...
    @ApiResponses({
            ...
            @ApiResponse(responseCode = "400", description = "잘못된 파라미터 입력")
    })
