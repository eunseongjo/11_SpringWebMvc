...
* 클래스 레벨에 URL을 공통 부분을 이용해 설정하고 나면 매번 핸들러 메소드에 URL의 중복되는 내용르 작성하지 않아도 된다.*/
...
/*1. Class 레벨 매핑*/
    ...
    public String modifyAndDelete(Model model){
        ...
        model.addAttribute("message", "POST 방식의 주문 정보 수정과 줌누 정보 삭제 공통처리용 핸들러 메소드 호출함...");
    ...
    * pathvariable로 전달되는 {변수명} 값은 반드시 매개변수명과 동일해야한다.
