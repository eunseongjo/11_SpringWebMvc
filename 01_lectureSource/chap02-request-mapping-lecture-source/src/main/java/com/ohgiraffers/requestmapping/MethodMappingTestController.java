...
public class MethodMappingTestController {
    /*1. 메소드 방식 미지정*/
    @RequestMapping("/menu/regist") // GET/POST 방식 모두 요청 가능
    ...
    /*2. 메소드 방식 지정*/
    /*요청 URL을 value 속성에, 요청 method를 mehtod 속성에 설정*/
    ...
    * PATCH             @PatchMapping
    * 이 어노테이션은 @RequesteMapping 어노테이션 method 속성을 사용하여 요청 방법을 지정하는 것과 같다.
   ...
   public String postDeleteMenu(Model model){
        ...
        model.addAttribute("message", "POST방식의 삭제용 핸들러 메소드 호출함 ...");
